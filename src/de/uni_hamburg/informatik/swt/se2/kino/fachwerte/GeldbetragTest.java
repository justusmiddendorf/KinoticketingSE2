...
public class GeldbetragTest
{
    ...
    {
        Geldbetrag geld = new Geldbetrag(500);
        //assertFalse(geld.istGueltigerEuroAnteil(0));
        assertFalse(geld.istGueltigerEuroAnteil(-50));
        assertTrue(geld.istGueltigerEuroAnteil(1));
        assertTrue(geld.istGueltigerEuroAnteil(10));
    }
    ...
    {
        Geldbetrag geld = new Geldbetrag(500);
        //assertFalse(geld.istGueltigerCentAnteil(0));
        assertFalse(geld.istGueltigerCentAnteil(-50));
        assertFalse(geld.istGueltigerCentAnteil(100));
        assertTrue(geld.istGueltigerCentAnteil(1));
        assertTrue(geld.istGueltigerCentAnteil(10));
    }
